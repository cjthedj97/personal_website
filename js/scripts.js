...
window.addEventListener('DOMContentLoaded', event => {
    ...
    if (heroTerminal && heroTerminalOutput) {
        ...
        const easterEggSequence = [
            { type: 'command', text: 'history | tail -7' },
            { type: 'output', text: '42 whoami' },
            { type: 'output', text: '43 uptime' },
            { type: 'output', text: '44 uname -a' },
            { type: 'output', text: '45 cat ~/notes/charges.txt' },
            { type: 'output', text: '46 cjctl status' },
            { type: 'output', text: '47 cjctl deep-dive' },
            { type: 'command', text: 'cat ~/notes/charges.txt' },
            { type: 'output', text: 'Count 1: Excessive curiosity' },
            { type: 'output', text: 'Count 2: Following rabbit holes' },
            { type: 'output', text: 'Count 3: Asking why' },
            { type: 'command', text: 'cjctl status' },
            ...
            { type: 'command', text: 'cjctl override --magic-word please' },
            { type: 'output', text: 'root access granted.' },
            { type: 'output', text: 'Welcome to the Grid.' }
        ];
